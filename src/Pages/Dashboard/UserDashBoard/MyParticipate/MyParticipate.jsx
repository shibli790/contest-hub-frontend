        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {contests.map((contest, index) => (
            <div
              ...
              className="group relative rounded-2xl p-6 bg-white/70 dark:bg-white/5  border border-white/20  backdrop-blur-xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
